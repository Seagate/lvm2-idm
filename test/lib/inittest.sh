...
LVM_TEST_BACKING_MULTI_DEVICES=${LVM_TEST_BACKING_MULTI_DEVICES-}
LVM_TEST_FAILURE_INJECTION=${LVM_TEST_FAILURE_INJECTION-}
LVM_TEST_MULTI_HOST_IDM=${LVM_TEST_MULTI_HOST_IDM-}
...
export LVM_TEST_BACKING_DEVICE LVM_TEST_BACKING_MULTI_DEVICES LVM_TEST_FAILURE_INJECTION LVM_TEST_DEVDIR LVM_TEST_NODEBUG
export LVM_TEST_MULTI_HOST_IDM
